...
(
    "ID" serial NOT NULL,
    "NikName" text COLLATE pg_catalog."default" NOT NULL,
    "RealName" text COLLATE pg_catalog."default" NOT NULL,
    "OriginDescription" text COLLATE pg_catalog."default" NOT NULL,
    "CatchPhrase" text COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT "Superheroes_pkey" PRIMARY KEY ("ID")
)

TABLESPACE pg_default;

ALTER TABLE public."Superheroes"
    OWNER to postgres;
...
(
    ...
    CONSTRAINT "Images_SuperheroID_fkey" FOREIGN KEY ("SuperheroID")
        REFERENCES public."Superheroes" ("ID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    "ID" serial NOT NULL,
    "SuperheroID" integer NOT NULL,
    "SuperPower" text COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT "SuperPowers_pkey" PRIMARY KEY ("ID")
)

TABLESPACE pg_default;

ALTER TABLE public."SuperPowers"
    OWNER to postgres;
